        ...
        <div class="lg:col-span-2">
            ...
            <div id="content-business" class="settings-content hidden">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('settings.update-business')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       name="business_name" 
                                       value="<?php echo e(old('business_name', $settings['business']['name'])); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                       required>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="business_address" 
                                          rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg"><?php echo e(old('business_address', $settings['business']['address'])); ?></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" 
                                           name="business_phone" 
                                           value="<?php echo e(old('business_phone', $settings['business']['phone'])); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" 
                                           name="business_email" 
                                           value="<?php echo e(old('business_email', $settings['business']['email'])); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="business_gst" 
                                       value="<?php echo e(old('business_gst', $settings['business']['gst'])); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg"
            ...
            <div id="content-api" class="settings-content hidden">
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('settings.update-api')); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <input type="url" 
                                           ...
                                           value="<?php echo e(old('woocommerce_url', $settings['woocommerce']['url'])); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo e(old('woocommerce_consumer_key', $settings['woocommerce']['consumer_key'] ? '***' . substr($settings['woocommerce']['consumer_key'], -4) : '')); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                ...
                                <div>
                                    ...
                                    <input type="password" 
                                           ...
                                           value="<?php echo e(old('woocommerce_consumer_secret')); ?>"
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?php echo e(old('razorpay_key_id', $settings['razorpay']['key_id'] ? '***' . substr($settings['razorpay']['key_id'], -4) : '')); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                ...
                                <div>
                                    ...
                                    <input type="password" 
                                           ...
                                           value="<?php echo e(old('razorpay_key_secret')); ?>"
                                           placeholder="Leave blank to keep current"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                                </div>
                            </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <input type="password" 
                                           ...
                                           value="<?php echo e(old('delhivery_api_token')); ?>"
                                           placeholder="Leave blank to keep current"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg">
...
<div class="border border-gray-200 rounded-lg p-4 mt-4">
    ...
    <form action="<?php echo e(route('orders.sync-workflow-statuses')); ?>" method="POST"
...
function testConnection(type) {
    ...
    fetch('<?php echo e(route("settings.test-connection")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\sardancoCrm\resources\views/settings/index.blade.php ENDPATH**/ ?>