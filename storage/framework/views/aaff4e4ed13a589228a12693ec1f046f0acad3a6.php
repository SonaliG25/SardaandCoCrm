...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div class="mt-4 md:mt-0 flex items-center space-x-3">
            <!-- <a href="<?php echo e(route('orders.export')); ?>" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-lg shadow-sm transition">
                <i class="fas fa-download mr-2"></i>
                Export Data
            </a>
            <a href="<?php echo e(route('orders.create')); ?>" class="inline-flex items-center px-4 py-2 bg-sarda-600 hover:bg-sarda-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
    ...
    <div class="bg-gradient-to-r from-sarda-600 to-sarda-700 rounded-lg shadow-lg p-6 text-white">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="text-3xl font-bold mb-1"><?php echo e($stats['total_orders']); ?></div>
                <div class="text-sarda-100 text-sm">Total Orders</div>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold mb-1"><?php echo e($stats['total_customers']); ?></div>
                <div class="text-sarda-100 text-sm">Total Customers</div>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold mb-1">&#8377;<?php echo e(number_format($stats['total_revenue'], 0)); ?></div>
                <div class="text-sarda-100 text-sm">Total Revenue</div>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold mb-1"><?php echo e($stageStats['ready_to_dispatch']); ?></div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['new_orders']); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-yellow-500 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['processing_orders']); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-purple-500 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['dispatched_orders']); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-green-500 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($stats['delivered_orders']); ?></p>
                    <p class="text-xs text-green-600 mt-2">
...
<!-- <div class="lg:col-span-2 bg-white rounded-lg shadow-sm p-6">
    ...
    <?php if($ordersByDate->count() > 0 && $ordersByDate->sum('count') > 0): ?>
        Chart with Data 
        <div class="space-y-4">
            <?php $__currentLoopData = $ordersByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-gray-700"><?php echo e(\Carbon\Carbon::parse($order->date)->format('M d, D')); ?></span>
                    <div class="flex items-center space-x-4">
                        <span class="text-sm text-gray-600">
                            <i class="fas fa-shopping-cart text-sarda-500 mr-1"></i>
                            <?php echo e($order->count); ?> <?php echo e($order->count == 1 ? 'order' : 'orders'); ?>

                        </span>
                        <span class="text-sm font-semibold text-sarda-600">â‚¹<?php echo e(number_format($order->revenue, 0)); ?></span>
                    </div>
                </div>
                <div class="w-full bg-gray-200 rounded-full h-4 shadow-inner">
                    ...
                    <div class="bg-gradient-to-r from-sarda-500 to-sarda-600 h-4 rounded-full shadow-sm transition-all duration-500 flex items-center justify-end pr-2" 
                        ...
                        <?php if($percentage > 15): ?>
                            <span class="text-xs font-bold text-white"><?php echo e($order->count); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <div class="grid grid-cols-3 gap-4">
                <div class="text-center">
                    ...
                    <div class="text-2xl font-bold text-gray-900"><?php echo e($ordersByDate->sum('count')); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-sm text-gray-600 mb-1">Total Revenue</div>
                    <div class="text-2xl font-bold text-sarda-600">â‚¹<?php echo e(number_format($ordersByDate->sum('revenue'), 0)); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-sm text-gray-600 mb-1">Avg. Order Value</div>
                    <div class="text-2xl font-bold text-gray-900">
                        â‚¹<?php echo e($ordersByDate->sum('count') > 0 ? number_format($ordersByDate->sum('revenue') / $ordersByDate->sum('count'), 0) : 0); ?>
    ...
    <?php else: ?>
      No Data State 
        <div class="text-center py-12">
            ...
            <a href="<?php echo e(route('orders.create')); ?>" class="inline-flex items-center px-4 py-2 bg-sarda-600 hover:bg-sarda-700 text-white font-medium rounded-lg shadow transition">
                <i class="fas fa-plus mr-2"></i>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors cursor-pointer">
                    ...
                    <span class="bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                        <?php echo e($stageStats['dye_pending']); ?>
                ...
                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors cursor-pointer">
                    ...
                    <span class="bg-green-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                        <?php echo e($stageStats['print_pending']); ?>
                ...
                <div class="flex items-center justify-between p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors cursor-pointer">
                    ...
                    <span class="bg-purple-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                        <?php echo e($stageStats['emb_pending']); ?>
                ...
                <div class="flex items-center justify-between p-3 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors cursor-pointer">
                    ...
                    <span class="bg-orange-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                        <?php echo e($stageStats['master_pending']); ?>
                ...
                <div class="flex items-center justify-between p-3 bg-gradient-to-r from-sarda-500 to-sarda-600 rounded-lg shadow-lg">
                    ...
                    <span class="bg-white text-sarda-700 text-xs font-bold px-3 py-1 rounded-full">
                        <?php echo e($stageStats['ready_to_dispatch']); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-4">
                ...
                <?php $__currentLoopData = $paymentStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <div class="p-3 <?php echo e($color['light']); ?> rounded-lg">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-sm font-medium <?php echo e($color['text']); ?> capitalize">
                            <?php echo e(str_replace('_', ' ', $status)); ?>

                        </span>
                        <span class="text-sm font-bold text-gray-900"><?php echo e($count); ?></span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="<?php echo e($color['bg']); ?> h-2 rounded-full transition-all duration-500" 
                             style="width: <?php echo e($percentage); ?>%"></div>
                    </div>
                    <div class="text-xs text-gray-600 mt-1 text-right"><?php echo e(number_format($percentage, 1)); ?>%</div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
                ...
                <?php $__currentLoopData = $shippingStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $shipping = $shippingIcons[$status] ?? ['icon' => 'fa-circle', 'color' => 'gray'];
                ?>
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <div class="flex items-center">
                        <i class="fas <?php echo e($shipping['icon']); ?> text-<?php echo e($shipping['color']); ?>-500 mr-3"></i>
                        <span class="text-sm text-gray-700 capitalize">
                            <?php echo e(str_replace('_', ' ', $status)); ?>

                        </span>
                    </div>
                    <span class="bg-<?php echo e($shipping['color']); ?>-100 text-<?php echo e($shipping['color']); ?>-700 text-xs font-semibold px-2.5 py-1 rounded-full">
                        <?php echo e($count); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-gray-50 to-white">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" class="text-sm text-sarda-600 hover:text-sarda-800 font-medium flex items-center">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                   ...
                   <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($order->order_date->format('d M Y')); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($order->order_date->diffForHumans()); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    
                                    <?php if($order->product_image): ?>
                                      <img src="<?php echo e(str_starts_with($order->product_image, 'http') ? $order->product_image : asset('storage/' . $order->product_image)); ?>"
                                         alt="Product" 
                                    ...
                                    <div>
                                        <div class="flex items-center space-x-2">
                                            <span class="text-sm font-bold text-gray-900"><?php echo e($order->woocommerce_order_id); ?></span>
                                            <?php if($order->woocommerce_order_id): ?>
                                                <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full" title="WooCommerce Order #<?php echo e($order->woocommerce_order_id); ?>">
                                                    <i class="fas fa-shopping-cart"></i> WC
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                        <?php if($order->awb_number): ?>
                                            <div class="text-xs text-gray-500 mt-1">AWB: <?php echo e($order->awb_number); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 rounded-full bg-sarda-100 flex items-center justify-center text-sarda-700 font-semibold mr-2">
                                        <?php echo e(strtoupper(substr($order->customer->name, 0, 1))); ?>

                                    </div>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($order->customer->name); ?></div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-semibold text-gray-900">₹<?php echo e(number_format($order->amount, 0)); ?></div>
                                <?php if($order->paid_amount > 0): ?>
                                    <div class="text-xs text-green-600">Paid: ₹<?php echo e(number_format($order->paid_amount, 0)); ?></div>
                                <?php endif; ?>
                            </td>
                           <td class="px-6 py-4 whitespace-nowrap">
    <div class="w-24">
        <div class="flex items-center justify-between text-xs text-gray-600 mb-1">
            <span class="font-medium
                <?php if($order->workflow_progress == 100): ?> text-green-600
                <?php elseif($order->workflow_progress >= 50): ?> text-sarda-600
                <?php else: ?> text-gray-500
                <?php endif; ?>">
                <?php echo e(number_format($order->workflow_progress, 0)); ?>%
            </span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2">
            <div class="h-2 rounded-full transition-all
                <?php if($order->workflow_progress == 100): ?> bg-green-500
                <?php else: ?> bg-gradient-to-r from-sarda-500 to-sarda-600
                <?php endif; ?>"
                 style="width: <?php echo e($order->workflow_progress); ?>%"></div>
        </div>
    </div>
</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php if($order->order_status == 'delivered'): ?> bg-green-100 text-green-800
                                    <?php elseif($order->order_status == 'dispatched'): ?> bg-blue-100 text-blue-800
                                    <?php elseif($order->order_status == 'processing'): ?> bg-yellow-100 text-yellow-800
                                    <?php elseif($order->order_status == 'new'): ?> bg-purple-100 text-purple-800
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php if($order->payment_status == 'received'): ?> bg-green-100 text-green-800
...
<td class="px-6 py-4 whitespace-nowrap">
    <div id="razorpay-status-<?php echo e($order->id); ?>">
        
        <!-- Step 1: Show Payment Gateway Badge -->
        <?php if($order->payment_gateway): ?>
            <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($order->payment_gateway_badge); ?> mb-2">
                <?php if($order->payment_gateway == 'razorpay'): ?>
                    <i class="fas fa-credit-card mr-1"></i> Razorpay
                <?php elseif($order->payment_gateway == 'cod'): ?>
                    <i class="fas fa-money-bill mr-1"></i> COD
                <?php elseif($order->payment_gateway == 'bank_transfer'): ?>
                    <i class="fas fa-university mr-1"></i> Bank Transfer
                <?php elseif($order->payment_gateway == 'cheque'): ?>
                    <i class="fas fa-file-invoice mr-1"></i> Cheque
                <?php else: ?>
                    <i class="fas fa-question-circle mr-1"></i> <?php echo e(ucfirst($order->payment_gateway)); ?>
        ...
        <?php if($order->payment_gateway == 'razorpay'): ?>
            ...
            <?php if($order->razorpay_payment_status): ?>
                ...
                <div class="mt-2">
                    <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                        <?php if($status == 'captured'): ?> bg-green-100 text-green-800
                        <?php elseif($status == 'authorized'): ?> bg-blue-100 text-blue-800
                        <?php elseif($status == 'created'): ?> bg-yellow-100 text-yellow-800
                        <?php elseif($status == 'failed'): ?> bg-red-100 text-red-800
                        <?php else: ?> bg-gray-100 text-gray-800
                        <?php endif; ?>">
                    ...
                    <?php if($order->razorpay_payment_method): ?>
                        <div class="text-xs text-gray-600 mt-1">
                            <i class="fas fa-wallet mr-1"></i><?php echo e(ucfirst($order->razorpay_payment_method)); ?>

                        </div>
                    <?php endif; ?>
                    
                    <?php if($order->razorpay_amount): ?>
                        <div class="text-xs text-gray-700 font-medium mt-1">
                            ₹<?php echo e(number_format($order->razorpay_amount, 0)); ?>

                        </div>
                    <?php endif; ?>
                    
                    <?php if($order->razorpay_checked_at): ?>
                        <div class="text-xs text-gray-400 mt-1">
                            <?php echo e(\Carbon\Carbon::parse($order->razorpay_checked_at)->diffForHumans()); ?>
                ...
                <?php if(in_array($status, ['captured', 'authorized'])): ?>
                    <div class="text-xs text-green-600 mt-2 flex items-center">
                        <i class="fas fa-shield-check mr-1"></i>
                        <span>Verified</span>
                    </div>
                <?php else: ?>
                    <button onclick="checkPayment(<?php echo e($order->id); ?>)" 
                            id="check-btn-<?php echo e($order->id); ?>"
                            class="text-xs text-indigo-600 hover:text-indigo-900 mt-2 flex items-center">
                        <i class="fas fa-sync-alt mr-1" id="check-icon-<?php echo e($order->id); ?>"></i>
                        <span id="check-text-<?php echo e($order->id); ?>">Check Again</span>
                    </button>
                <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <button onclick="checkPayment(<?php echo e($order->id); ?>)" 
                    ...
                    <i class="fas fa-search-dollar mr-1" id="check-icon-<?php echo e($order->id); ?>"></i>
                    <span id="check-text-<?php echo e($order->id); ?>">Check Payment</span>
                </button>
            <?php endif; ?>
        ...
        <?php endif; ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($order->shippingPartner): ?>
                                    <div class="text-sm text-gray-900"><?php echo e($order->shippingPartner->name); ?></div>
                                    <span class="text-xs text-gray-500 capitalize"><?php echo e(str_replace('_', ' ', $order->shipping_status)); ?></span>
                                <?php else: ?>
                                    <span class="text-xs text-gray-400">Not assigned</span>
                                <?php endif; ?>
                            </td>
                           <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="<?php echo e(route('orders.show', $order)); ?>" class="text-sarda-600 hover:text-sarda-900 font-medium">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="<?php echo e(route('orders.create')); ?>" class="inline-flex items-center mt-4 px-4 py-2 bg-sarda-600 hover:bg-sarda-700 text-white font-medium rounded-lg shadow transition">
                                <i class="fas fa-plus mr-2"></i>
                                Create Order
                            </a>
                        </td>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="<?php echo e(route('orders.index', ['status' => 'new'])); ?>" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-all transform hover:-translate-y-1 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    <h4 class="text-sm font-medium text-gray-600 mb-1">New Orders</h4>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['new_orders']); ?></p>
        ...
        <a href="<?php echo e(route('orders.index', ['payment_status' => 'pending'])); ?>" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-all transform hover:-translate-y-1 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    <h4 class="text-sm font-medium text-gray-600 mb-1">Pending Payments</h4>
                    <p class="text-2xl font-bold text-gray-900">&#8377;<?php echo e(number_format($stats['pending_payment'], 0)); ?></p>
        ...
        <a href="<?php echo e(route('vendors.index')); ?>" class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-all transform hover:-translate-y-1 border-l-4 border-sarda-500">
            <div class="flex items-center justify-between">
                <div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\sardancoCrm\resources\views/dashboard/index.blade.php ENDPATH**/ ?>